...
THE PIPELINE YOU FEED: you draw the SVG and port the Swift. A separate **Codex team** owns
the web peer + tRPC wiring, and a separate **Codex Xcode agent** registers files in
