...
THE PIPELINE YOU FEED: you draw the SVG + port the Swift. The **Codex team** owns the web
peer + tRPC wiring; the **Codex Xcode agent** registers files in project.pbxproj, runs ⌘B,
