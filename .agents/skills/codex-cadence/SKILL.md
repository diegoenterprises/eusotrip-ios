...
- **Correct another agent's work without ceremony, and credit what was right.** "Codex had
...
3. **Never edit another agent's dirty checkout.** "Codex's active checkout is actually behind
...
The Aug 1 lane did ~2 hours of its best work in `/tmp/eusotrip-Codex-capture`. macOS deleted
