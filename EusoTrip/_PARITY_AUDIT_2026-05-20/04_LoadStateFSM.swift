...
/// Transport mode — the third dimension after vertical and trailer.
public enum TransportMode: String, CaseIterable, Codable, Hashable {
    case truck, rail, vessel, barge, intermodal
}
