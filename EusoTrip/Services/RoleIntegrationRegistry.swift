...
enum RoleIntegrationRegistry {
    ...
    private static let truckCatalyst: [RoleIntegration] = [
        ...
        .init(roleKey: "CATALYST", slug: "wex",           name: "WEX Fleet",     function: "Fuel card",              docs: "https://www.wexinc.com",        category: .fuelCard),
    ...
    private static let truckBroker: [RoleIntegration] = [
        ...
        .init(roleKey: "BROKER", slug: "trimble-tmw",    name: "Trimble TMW",       function: "Trimble freight TMS",       docs: "https://transportation.trimble.com", category: .tms),
    ...
    private static let truckFactoring: [RoleIntegration] = [
        ...
        .init(roleKey: "FACTORING", slug: "rts-financial",   name: "RTS Financial",   function: "Factoring",                 docs: "https://www.rtsinc.com",      category: .factoring),
    ...
    private static let vesselShipper: [RoleIntegration] = [
        ...
        .init(roleKey: "VESSEL_SHIPPER", slug: "hapag",         name: "Hapag-Lloyd",          function: "Booking + rates",             docs: "https://www.hapag-lloyd.com/en/online-business/api.html",        category: .oceanCarrier),
    ...
    private static let vesselOperator: [RoleIntegration] = [
        .init(roleKey: "VESSEL_OPERATOR", slug: "marinetraffic", name: "MarineTraffic",         function: "AIS positions",     docs: "https://www.marinetraffic.com/en/ais-api-services",      category: .marine),
    ...
    private static let portMaster: [RoleIntegration] = [
        ...
        .init(roleKey: "PORT_MASTER", slug: "zpmc",         name: "ZPMC",              function: "Crane mfr telematics", docs: "https://www.zpmc.com",          category: .crane),
