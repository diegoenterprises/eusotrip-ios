...
public enum AnimationBindingMap {
    ...
    public static let truck: [TrailerCode: AnimationFilePair] = [
        ...
        .autoCarrier:          .init(loading: "11_power_only_loading.svg",      unloading: "11_power_only_unloading.svg",      hero: "11_power_only_anim.svg"),
        // T-029b backlog — missing truck variants fall back to dryVan
        // for state animation, hero stays on the original 33-SVG drop
        // (each entry's `hero` field is the closest-shape v1 hero).
        .pneumaticTank:        .init(loading: "10_tanker_gas_loading.svg",       unloading: "10_tanker_gas_unloading.svg",       hero: "10_tanker_gas_anim.svg"),
        .endDump:              .init(loading: "03_flatbed_loading.svg",          unloading: "03_flatbed_unloading.svg",          hero: "03_flatbed_anim.svg"),
        .waterTank:            .init(loading: "09_tanker_liquid_loading.svg",    unloading: "09_tanker_liquid_unloading.svg",    hero: "09_tanker_liquid_anim.svg"),
        .livestockCattlePot:   .init(loading: "01_dry_van_loading.svg",          unloading: "01_dry_van_unloading.svg",          hero: "01_dry_van_anim.svg"),
        .logTrailer:           .init(loading: "03_flatbed_loading.svg",          unloading: "03_flatbed_unloading.svg",          hero: "03_flatbed_anim.svg"),
        .curtainSide:          .init(loading: "01_dry_van_loading.svg",          unloading: "01_dry_van_unloading.svg",          hero: "01_dry_van_anim.svg"),
        .dryBulkHopper:        .init(loading: "10_tanker_gas_loading.svg",       unloading: "10_tanker_gas_unloading.svg",       hero: "10_tanker_gas_anim.svg"),
        .gravityHopper:        .init(loading: "10_tanker_gas_loading.svg",       unloading: "10_tanker_gas_unloading.svg",       hero: "10_tanker_gas_anim.svg"),
        .grainHopper:          .init(loading: "10_tanker_gas_loading.svg",       unloading: "10_tanker_gas_unloading.svg",       hero: "10_tanker_gas_anim.svg"),
