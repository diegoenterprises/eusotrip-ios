...
enum EusoRole: String, CaseIterable, Codable, Hashable, Identifiable {
    ...
    // Granted through verified Zeun provider membership, not public signup.
    ...
    /// The 24 public registration journeys. SERVICE_PROVIDER is granted only
    /// through verified Zeun provider onboarding and stays out of this list.
    ///
    ...
    /// path. All 24 public roles now have server procs (the 14 rail /
