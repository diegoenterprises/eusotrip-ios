...
private struct RailRFPMultiCarrierBody: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack(spacing: 0) {
                EusoTripEyebrow(verbatim: "SHIPPER · RAIL · MULTI-CARRIER RFP")
    ...
    private var bidSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("No verified bid amounts are available for this RFP. Carriers are ranked by their live acceptance rate.")
