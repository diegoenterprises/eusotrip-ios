            ...
            VStack(alignment: .leading, spacing: Space.s4) {
                ...
                if loading {
                    ...
                    EusoEmptyState(
                        ...
                        subtitle: "No spot-held trailer resolved from the yard map. Equipment detail reads getTrailerDetails once a trailer is in a slot.",
                        comingSoon: false
                    )
                }
        ...
        VStack(alignment: .leading, spacing: Space.s3) {
            ...
            if moves.isEmpty {
                EusoEmptyState(
                    ...
                    subtitle: "The move timeline fills from getTrailerDetails.moveHistory as this trailer is grounded, returned, and drayed.",
                    comingSoon: false
                )
            } else {
