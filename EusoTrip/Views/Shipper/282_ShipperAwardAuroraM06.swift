//
//  282_ShipperAwardAuroraM06.swift
//  EusoTrip — Shipper · LIFECYCLE ECHO · AWARDED (M-06 chain).
//
//  Wireframe: 02 Shipper/Dark-SVG/282 Shipper Award Aurora M06.svg
//  Archetype: DETAIL + money-led outcomes ledger. The M-06 dialect of 274.
//  Closes the bidding loop in one decisive view: who won, what was saved
//  against target, and the underbidders surfaced with the amount each lost by.
//
...
struct ShipperAwardAuroraM06Screen: View {
        ...
        Shell(theme: theme) {
            VStack(alignment: .leading, spacing: Space.s4) {
                ShipperEchoSnapshotView(loadId: loadId, eyebrow: "SHIPPER · LOAD · AWARDED") { live in
                    AwardM06Body(live: live, loadId: loadId)
                }
            }
...
private struct AwardM06Body: View {
...
#Preview("282 · Award M06 · Night") {
    ShipperAwardAuroraM06Screen(theme: Theme.dark, loadId: "0")
        .environmentObject(EusoTripSession()).preferredColorScheme(.dark)
}
#Preview("282 · Award M06 · Afternoon") {
    ShipperAwardAuroraM06Screen(theme: Theme.light, loadId: "0")
