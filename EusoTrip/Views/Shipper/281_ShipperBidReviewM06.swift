//
//  281_ShipperBidReviewM06.swift
//  EusoTrip — Shipper · LIFECYCLE ECHO · BIDDING (M-06 chain).
//
//  Wireframe: 02 Shipper/Dark-SVG/281 Shipper Bid Review M06.svg
//  Archetype: DETAIL + bid leaderboard. The M-06 dialect of 273 (a reefer
//  produce lane). Shows Diego the live board mid-window — the cheapest quote
//  at the top with a safety grade he can trust, his favorite carrier ranked
//  below so the choice is never just price, and one tap to accept the leader.
//
...
struct ShipperBidReviewM06Screen: View {
        ...
        Shell(theme: theme) {
            VStack(alignment: .leading, spacing: Space.s4) {
                ShipperEchoSnapshotView(loadId: loadId, eyebrow: "SHIPPER · LOAD · BIDDING") { live in
                    BidReviewM06Body(live: live, loadId: loadId)
                }
            }
...
private struct BidReviewM06Body: View {
...
#Preview("281 · Bid review M06 · Night") {
    ShipperBidReviewM06Screen(theme: Theme.dark, loadId: "0")
        .environmentObject(EusoTripSession()).preferredColorScheme(.dark)
}
#Preview("281 · Bid review M06 · Afternoon") {
    ShipperBidReviewM06Screen(theme: Theme.light, loadId: "0")
