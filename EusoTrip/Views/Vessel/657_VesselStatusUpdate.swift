...
private struct VesselStatusUpdateBody: View {
    ...
    private func confirm() async {
        ...
        struct StatusIn: Encodable { let id: Int; let requestKey: String; let newStatus: String }
        struct Empty657: Decodable {}
        do {
            let _: Empty657 = try await EusoTripAPI.shared.mutation(
                "vesselShipments.updateVesselShipmentStatus",
                input: StatusIn(id: bookingId, requestKey: UUID().uuidString, newStatus: selected))
            done = true
