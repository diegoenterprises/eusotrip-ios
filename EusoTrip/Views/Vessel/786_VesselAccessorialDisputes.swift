...
private struct VesselAccessorialDisputesBody: View {
            ...
            VStack(alignment: .leading, spacing: Space.s4) {
                ...
                if loading {
                    ...
                    EusoEmptyState(systemImage: "checkmark.seal",
                                   ...
                                   subtitle: "getAccessorialDisputes returned no contested charges. Nothing awaiting a carrier reply right now.")
                } else {
                    heroCard
                    agingCard
                    worklistCard
    ...
    private func exportGap() {
        actionMessage = nil
        actionError = "Dispute export isn't wired yet — detentionAccessorials.exportDetentionLedger is a named server gap. The worklist reads live; the CSV/PDF writer is pending."
    }
