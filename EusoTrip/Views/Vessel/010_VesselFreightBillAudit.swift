...
struct VesselShipperFreightBillAuditScreen: View {
    ...
    init(theme: Theme.Palette, shipmentId: Int = 48217, invoiceRef: String = "MAEU-72104") {
    ...
    var body: some View {
        Shell(theme: theme) {
            ...
            // AXIS E · Shipper enum. The retired slot drew a clock labelled "Track" — the vessel
            // OPERATOR enum — on a Shipper-family screen.
            BottomNav(
...
private struct VesselFreightBillAuditBody: View {
    ...
    @State private var lane = "CNSHA → USLGB"
    @State private var bookingNumber = "VES-260524-7B3D90F2C5"
    ...
    private var canFile: Bool { !filing && !offline && recoverable > 0 }
