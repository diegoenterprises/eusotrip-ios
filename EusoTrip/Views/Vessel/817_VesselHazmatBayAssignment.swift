    ...
    private var apronBoard: some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack {
                ...
                Spacer()
                Text("getHazmatBays:610").font(EType.mono(.micro)).foregroundStyle(palette.textTertiary)
            }
    ...
    private var assignmentLedger: some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack {
                ...
                Spacer()
                Text("STUB · getPendingHazmatUnits").font(EType.mono(.micro)).foregroundStyle(palette.textTertiary)
            }
