...
private struct VesselDetentionByFacilityBody: View {
            ...
            VStack(alignment: .leading, spacing: Space.s4) {
                ...
                if loading {
                    ...
                    EusoEmptyState(systemImage: "chart.bar.xaxis",
                                   ...
                                   subtitle: "No terminal detention charges were found in this window.")
                } else {
                    rankingCard
                    esangCard
                    ctaPair
    ...
    private func exportGap() {
        actionError = "Export is not available for this view. The live facility ranking remains available here."
    }
