...
private struct VesselActiveDetentionsBody: View {
            ...
            VStack(alignment: .leading, spacing: Space.s4) {
                ...
                if loading {
                    ...
                    EusoEmptyState(systemImage: "timer",
                                   ...
                                   subtitle: "No containers are accruing detention. Nothing is past free time right now.")
                } else {
                    billableCard
                    kpiStrip
                    runningLedger
    ...
    private func exportGap() {
        actionError = "Export is not available for this view. Live accruing containers remain available here."
    }
