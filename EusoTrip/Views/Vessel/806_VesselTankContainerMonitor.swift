...
private struct VesselTankContainerMonitorBody: View {
        ...
        HStack(alignment: .center, spacing: Space.s4) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                if let w = worstBox {
                    ...
                    Text("No tank feed is linked to this vessel container. Live gauges remain hidden.")
        ...
        VStack(alignment: .leading, spacing: Space.s2) {
            ...
            if readings.isEmpty {
                EusoEmptyState(systemImage: "gauge.with.dots.needle.bottom.50percent",
                               ...
                               subtitle: "Live pressure and lading temperature appear after a verified tank feed is linked.")
            } else {
                VStack(spacing: 0) {
    ...
    private var esangSub: String {
        guard hasReadings else { return "No verified tank feed" }
