...
private struct VesselForwarderPortalBody: View {
    ...
    private var topBar: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack {
                EusoTripEyebrow(verbatim: "VESSEL OPERATOR · FORWARDER PORTAL")
    ...
    private var consolidationBand: some View {
        VStack(alignment: .leading, spacing: Space.s2) {
            Text("CONSOLIDATION OPPORTUNITIES · LIVE MATCHES")
    ...
    private var sharedLedger: some View {
        VStack(alignment: .leading, spacing: Space.s2) {
            Text("SHARED SHIPMENTS · AUTHORIZED ACCESS")
                .font(.system(size: 9, weight: .heavy)).tracking(1.0).foregroundStyle(palette.textTertiary)
    ...
    private var grantConsole: some View {
        VStack(alignment: .leading, spacing: Space.s3) {
            Text("GRANT 3PL ACCESS · CONFIRM REQUIRED")
                .font(.system(size: 9, weight: .heavy)).tracking(1.0).foregroundStyle(palette.textTertiary)
            VStack(alignment: .leading, spacing: Space.s3) {
