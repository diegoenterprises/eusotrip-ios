...
struct VesselTradeDocsConfig {
    ...
    static let caImport = VesselTradeDocsConfig(
        ...
        gapNote: "Requirements shown are the verified CBSA import set. Select a booking before attaching documents or advancing release. Form B3 filing remains in the authorized customs channel."
    )
    ...
    static let mxImport = VesselTradeDocsConfig(
        ...
        actionKeywords: ["nom"],
        gapNote: "Requirements shown are the verified Mexican customs import set. Select a booking before attaching documents or advancing modulación. NOM-050 review remains in the authorized customs channel."
    )
}
