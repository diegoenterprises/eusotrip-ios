...
private struct VesselCFSDeconsolidationPlanBody746: View {
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                if loading {
                    ...
                    EusoEmptyState(systemImage: "arrow.triangle.branch",
                                   ...
                                   subtitle: "getCrossDockOperations returned an empty cross-dock plan for this facility.")
                }
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("Pier J CFS · getCrossDockOperations").font(.system(size: 11, design: .monospaced)).foregroundStyle(palette.textSecondary)
        }
    }
    ...
    private var boardHeader: some View {
        HStack {
            ...
            Spacer()
            Text("getCrossDockOperations").font(.system(size: 9, weight: .heavy, design: .monospaced)).kerning(0.4).foregroundStyle(palette.textTertiary)
        }
    }
