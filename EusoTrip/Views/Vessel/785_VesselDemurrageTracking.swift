...
private struct VesselDemurrageTrackingBody: View {
            ...
            VStack(alignment: .leading, spacing: Space.s4) {
                ...
                if loading {
                    ...
                    EusoEmptyState(systemImage: "shippingbox.circle",
                                   ...
                                   subtitle: "No per-diem containers were found in this window. Nothing is past free time.")
                } else {
                    accrualCard
                    kpiStrip
                    containerLedger
    ...
    private func exportGap() {
        actionError = "Export is not available for this view. Live demurrage records remain available here."
    }
