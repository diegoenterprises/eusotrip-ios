...
struct EditableProfileAvatar: View {
        ...
        PhotosPicker(
            ...
            ZStack(alignment: .bottomTrailing) {
                avatarContent
                    ...
                    .clipShape(Circle())
                    .overlay {
                        Circle().strokeBorder(LinearGradient.diagonal.opacity(0.9), lineWidth: 1.5)
                    }
    ...
    private func loadProfile() async {
        ...
        do {
            ...
            // Keep an already-rendered photo in place while exposing the failed read.
    ...
    private func upload(dataURL: String) async throws -> String? {
        ...
        guard result.success else { throw AvatarUploadError.serverRejected }
    ...
    private static func compressedJPEG(from source: Data) throws -> Data {
        ...
        // The server accepts at most 45 KB of decoded image bytes and stores the
        // data URL in a 64 KB TEXT column. Keep binary bytes below 37 KB so base64
        // inflation and the data-URL prefix remain safely under both limits.
