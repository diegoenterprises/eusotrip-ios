...
// 065 ships the Haul-tab custom variant (Haul current, frozen per
// [feedback_bottom_nav_frozen]). iOS file `TheHaulStreaks` but PNG
// slot rebranded to "EusoTicket Exception" — same iOS-vs-PNG
// mismatch as 057-064, out of safe-mode scope. Only SF Symbol
// naming polish.
