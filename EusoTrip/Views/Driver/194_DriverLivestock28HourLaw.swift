...
//
//  §W OFFLINE POLICY: ONLINE_ONLY(the feed/water/rest certification is a federal animal-welfare
//  compliance write under 49 USC 80502 and the drive clock backing it must
//  be live).
