...
//
//  §W OFFLINE POLICY: ONLINE_ONLY(no loadId-keyed cargo-tank read or write endpoint exists for a
//  moving MC-331 — see the HONEST GAP above. The checkpoint currently
//  persists nowhere at all, so nothing on this surface may claim to be
...
struct DriverTankerMonitorScreen: View {
    ...
    var body: some View {
        Shell(theme: theme) {
            ...
            TankerMonitorBody(loadId: loadId, onBack: {
