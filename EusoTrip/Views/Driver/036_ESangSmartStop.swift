...
struct eSangSmartStop: View {
    ...
    private var heroSubhead: String {
        ...
        return "Live ranking from EusoMap, OPIS, Eusorone Parking and FMCSA HOS rules."
    }
    ...
    private var footerAttribution: String {
        "ESANG RANKS LIVE · DATA FUSED FROM EUSOMAP, OPIS, EUSORONE PARKING, FMCSA HOS RULE"
    }
