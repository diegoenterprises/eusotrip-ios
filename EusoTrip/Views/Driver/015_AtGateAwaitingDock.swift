...
// PNG canon at `01 Driver/{Light,Dark}/015 At Gate · Awaiting Dock.png`
// pins TRIPS current on lifecycle Ring 3. Icon set + trailing slot
// normalized to canonical 010-014 layout.
